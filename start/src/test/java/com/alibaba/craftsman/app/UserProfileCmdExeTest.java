...
public class UserProfileCmdExeTest extends MockTestBase {
    ...
    public void testSuccessAdd(){
        ...
        Response response = userProfileServiceImpl.addUserProfile(userProfileAddCmd);
        Assert.assertTrue(response.isSuccess());

        RefreshScoreCmd refreshScoreCmd = new RefreshScoreCmd(userId);
        userProfileServiceImpl.refreshScore(refreshScoreCmd);

        UserProfileGetQry userProfileGetQry = new UserProfileGetQry();
        userProfileGetQry.setUserId(userId);
        UserProfileCO result = userProfileServiceImpl.getUserProfileBy(userProfileGetQry).getData();
    ...
    public void testSuccessUpdate(){
        ...
        Response response = userProfileServiceImpl.updateUserProfile(userProfileUpdateCmd);
        Assert.assertTrue(response.isSuccess());
